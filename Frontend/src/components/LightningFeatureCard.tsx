    ...
    <div className="relative w-[335px] h-[534px] bg-gradient-to-b from-gray-800/80 to-gray-900/90 rounded-xl overflow-hidden">
      ...
      <div className="absolute left-1/2 top-2/5 -translate-x-1/2 -translate-y-1/2">
        <div className="relative">
          ...
          <svg
            className="w-60 h-96 text-blue-100/90 relative z-10"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 z-10">
        <h3 className="text-sm font-semibold  mb-3 text-transparent bg-gradient-to-r from-[#f2f3f5] via-[#c2cbff] to-[#7b8fff] bg-clip-text">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-60 bg-gradient-to-t from-gray-900/90 to-transparent"></div>
    </div>
  );
};